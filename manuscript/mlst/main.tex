...
All datasets are generated synthetically. The manuscript-specific data generators, evaluation scripts, random seeds, and machine-readable result tables are publicly available at \url{https://github.com/shchng9963-droid/fidelityno} under the release tag mlst-submission-v1. Training arrays and model checkpoints can be regenerated using the documented commands. An archival DOI will be added when the versioned release is deposited.

\section*{Code availability}

The source code associated with this manuscript is publicly available at \url{https://github.com/shchng9963-droid/fidelityno} under the release tag mlst-submission-v1. The tag identifies the exact Git commit, and the software environment is documented in the repository.
