...
\begin{table}[h]
\centering
\caption{\textbf{Collision regime: pre-affine distribution metrics for \fidno{}.} Results pool five seeds and 1024 sequences. Mean absolute error is the raw point error before affine calibration. Expected calibration error uses the predicted median band. Continuous ranked probability score uses all nine quantiles after the in-distribution correction.}
