...
All datasets are generated synthetically. The manuscript-specific data generators, evaluation scripts, random seeds, and machine-readable result tables are maintained in the project repository at \url{https://github.com/shchng9963-droid/fidelityno} and will be included in the public release associated with this manuscript. Training arrays and model checkpoints can be regenerated using the documented commands. A versioned archive and archival DOI will accompany the public release.

\section*{Code availability}

The public project repository is available at \url{https://github.com/shchng9963-droid/fidelityno}. The manuscript-specific revision will be released there and will identify the exact Git commit and software environment.
